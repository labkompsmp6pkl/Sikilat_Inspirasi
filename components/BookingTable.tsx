                    ...
                    <div className="flex items-center justify-end gap-3">
                        ...
                        {booking.status_peminjaman === 'Disetujui' ? (
                            ...
                            <div className="flex gap-2">
                                {canManage ? (
                                    <>
                                        <button onClick={() => onUpdateStatus?.(booking.id_peminjaman, 'Disetujui')} className="px-4 py-2 bg-indigo-600 text-white text-[10px] font-black rounded-lg hover:bg-indigo-700 shadow-md">SETUJUI</button>
                                        <button onClick={() => onUpdateStatus?.(booking.id_peminjaman, 'Ditolak')} className="px-4 py-2 bg-rose-600 text-white text-[10px] font-black rounded-lg hover:bg-rose-700 shadow-md">TOLAK</button>
                                    </>
                                ) : (
