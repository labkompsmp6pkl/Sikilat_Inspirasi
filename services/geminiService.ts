...
const runSimulation = (message: string, user: User): GeminiResponse | null => {
    ...
    // --- 1. FORM SUBMISSIONS (Harus di cek paling awal agar tidak tertabrak trigger keywords) ---

    // Handling Input Kegiatan Form Submission
    ...
    // --- 2. FORM TRIGGERS (Kata kunci pemicu munculnya form) ---
